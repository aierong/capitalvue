    ...
    export default {
        ...
        data () {
            return {
                ...
                DlgObj : {
                    ...
                    capitalcode : '' ,
                    nos : '' ,
                    notype : globalconstant.notype.scrap ,
                    tabindex : 0 ,
                    tempdata : ''
                } ,
        ...
        methods : {
            ...
            async loaddata () {
                ...
                let list = await scrapapi.getaddscrapquerylistbyminid( this.minautokey ,
                    counts ,
            ...
            async initlist () {
                ...
                let list = await scrapapi.getaddscrapquerylistbyminid( 0 ,
                    initcount ,
